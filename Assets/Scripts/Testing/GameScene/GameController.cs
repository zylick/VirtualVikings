...
public class GameController : MonoBehaviour
{
	...
	void Start ()
	{
		...
		mPlayerIcon.SetActive (false); // Turn the player icon off since we are going to First Person.
		mPlayerObject.GetComponent<BoxCollider> ().enabled = false; // Turn off the box collider on the player
